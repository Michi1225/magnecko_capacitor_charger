...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : OC_Pin WD_SNS_Pin */
  GPIO_InitStruct.Pin = OC_Pin|WD_SNS_Pin;
  ...
  /*Configure GPIO pin : nWD_RST_Pin */
  GPIO_InitStruct.Pin = nWD_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(nWD_RST_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : nCLR_OC_Pin */
  GPIO_InitStruct.Pin = nCLR_OC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(nCLR_OC_GPIO_Port, &GPIO_InitStruct);
