...
void MX_DFSDM1_Init(void)
{
  ...
  hdfsdm1_channel1.Init.OutputClock.Divider = 7;
...
void HAL_DFSDM_FilterMspInit(DFSDM_Filter_HandleTypeDef* dfsdm_filterHandle)
{
  ...
  */
    ...
    PB1     ------> DFSDM1_DATIN1
    */
    GPIO_InitStruct.Pin = DS_VCAP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_DFSDM1;
    HAL_GPIO_Init(DS_VCAP_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DS_CLKOUT_Pin|DS_IOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_DFSDM_FilterMspDeInit(DFSDM_Filter_HandleTypeDef* dfsdm_filterHandle)
{
  ...
  /* USER CODE END DFSDM1_MspDeInit 0 */
    ...
    PB1     ------> DFSDM1_DATIN1
    */
    HAL_GPIO_DeInit(DS_VCAP_GPIO_Port, DS_VCAP_Pin);

    HAL_GPIO_DeInit(GPIOB, DS_CLKOUT_Pin|DS_IOUT_Pin);
